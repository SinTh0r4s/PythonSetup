...
[![Coverage](https://img.shields.io/badge/coverage-100%25-green)](https://github.com/SinTh0r4s/PythonSetup/actions/workflows/pr-check.yml)
...
- Install `poetry`. It is a package manager and used by PythonSetup and should be installed globally: `pip install poetry`. It will now be available in your terminal as `poetry`
